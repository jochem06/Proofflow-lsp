...
//   gotoDeclaration
// };
var path = 'C:/Users/smile/Documents/SEP/Proofflow-lsp/src/mock/mock.vo';
var uri = (0, url_1.pathToFileURL)(path).href;
startServer().then(function () {
    initializeServer(uri).then(function () {
        initialized().then(function () {
            didOpen(uri, 'coq', 'example', '1');
        });
    });
});
